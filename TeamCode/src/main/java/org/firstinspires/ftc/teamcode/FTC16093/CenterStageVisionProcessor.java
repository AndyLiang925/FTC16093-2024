...
public class CenterStageVisionProcessor implements VisionProcessor{
    ...
    public static int rectMiddle_x = 265,rectMiddle_y = 275, rectMiddle_width = 150, rectMiddle_height = 55;
    public static int rectRight_x = 455,rectRight_y = 295, rectRight_width = 80, rectRight_height = 60;
