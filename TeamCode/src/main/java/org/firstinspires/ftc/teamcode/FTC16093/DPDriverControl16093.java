...
//@TeleOp
//public class DPDriverControl16093 extends LinearOpMode{
...
//        aml = hardwareMap.get(DcMotorEx.class, "aml");
...
//        aml.setDirection(DcMotorEx.Direction.REVERSE);
//        gb1.setDirection(Servo.Direction.REVERSE);
//        gb2.setDirection(Servo.Direction.FORWARD);
...
//        aml.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
//        aml.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
//        aml.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
//
//        double speed = 1;
//        double fjpos = 0.58;
//        double wrtpos = 0.57;
...
//                armDrive.setPower(1);
//            }
//            aml.setTargetPosition(amlp);
//            aml.setMode(DcMotor.RunMode.RUN_TO_POSITION);
//            if(aml.getCurrentPosition()<amlp){
//                aml.setPower(-1);
//            }else{
//                aml.setPower(1);
//            }
