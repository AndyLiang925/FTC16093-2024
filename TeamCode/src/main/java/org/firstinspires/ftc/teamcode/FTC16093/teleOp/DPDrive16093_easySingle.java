...
@TeleOp
public class DPDrive16093_easySingle extends LinearOpMode {//
    ...
    int mode=0;
    private DPDrive16093_easySingle.Sequence sequence;
...
//        }
        ...
        XCYBoolean distal = new XCYBoolean(()->gamepad1.y);
        ...
        XCYBoolean armExpandBack = new XCYBoolean(()->gamepad1.start);
        ...
        XCYBoolean plane_shoot = new XCYBoolean(()->gamepad2.y);
...
//            }
            ...
            if(toRun.toTrue()){
                ...
                wrtp=1;
                wrt.setPosition(wrtp);
                sequence= DPDrive16093_easySingle.Sequence.RUN;
            ...
            if(drop.toTrue()){
                ...
                pd=0;
                pdArm=0;
                sequence= DPDrive16093_easySingle.Sequence.RELEASE;
                telemetry.addData("re lease",0);
                leftGrabOpen=false;
                rightGrabOpen=false;
                gb1.setPosition(leftGrabOpen?0.6:grab1_close);
                gb2.setPosition(rightGrabOpen?0.22:grab2_close);
            ...
            if(aim.toTrue()){
                ...
                wrtp=0.61;
                wrt.setPosition(wrtp);
                sequence= DPDrive16093_easySingle.Sequence.AIM;
...
//                }
            ...
            if(sequence== DPDrive16093_easySingle.Sequence.AIM){
                speed = 0.5;
                if(distal.toTrue()){
                    setArmPosition(240);
                    leftGrabOpen=true;
...
//                }else{
            ...
            if(sequence== DPDrive16093_easySingle.Sequence.RUN){
                setArmLength(0);
                setArmPosition(0);
                wrtp=1;
                wrt.setPosition(wrtp);
            ...
            if(sequence== DPDrive16093_easySingle.Sequence.RELEASE) {
                speed = 0.4;
                if (armDropUp.toTrue()) {
...
//                    }
            ...
            telemetry.addData("操作模式:", sequence== DPDrive16093_easySingle.Sequence.AIM?"aim1":(sequence== DPDrive16093_easySingle.Sequence.RUN?"run":(sequence== DPDrive16093_easySingle.Sequence.RELEASE?"drop":"null")));//drive mode
