...
public class AutoMaster extends LinearOpMode {
    ...
    Pose2d yellowBackDropPosition = new Pose2d(47.8, 33 * side_color, Math.toRadians(180)); //47 blue
    ...
    private Pose2d getDropPose(double pos) {
        return new Pose2d(47.5, side_color * backDrop_centerAxis_y + pos * pixel_width, Math.toRadians(backDrop_heading));
    } // blue 47.3
    ...
    public static double intake_nearGrab_x = -58, intake_distal_y = 9.6;
    private Pose2d intake_near;
    public static double grab_x = -43;
    public static double intake_x = -35;
    public static double gateFront_x = -24;
    public static double gateBack_x = 15;
    public static double gate_y = 10;
    public static double middle_y = 26;
    public static double side_y = 53;
    public static double intake_gate_y = 9.7;
    public static double intake_middle_y = 21; //todo
    public static double intake_side_y = 32;
    ...
    Pose2d intake_gate, intake_middle,intake_side;
...
//        drive.followTrajectorySequence(moveToSpikeMark);
    ...
    public void moveToBackDrop() {
        ...
        Trajectory moveToDetectedBackDrop_closer = drive.trajectoryBuilder(new Pose2d(40, side_color * backDrop_centerAxis_y + drop_pos_index * pixel_width, Math.toRadians(180)))
                ...
                .build();
        upper.setArmPosition(2800);
        //drive.followTrajectory(moveToDetectedBackDrop);
        drive.moveTo(new Pose2d(40, side_color * backDrop_centerAxis_y + drop_pos_index * pixel_width, Math.toRadians(180)), 400);
    ...
    public void intakeDistal() {
        ...
        TrajectorySequence toMediByLine = drive.trajectorySequenceBuilder(spikeMark)
                .lineToLinearHeading(new Pose2d(-57.8, intake_side_y * side_color, Math.toRadians(180)))
                .build();

        Trajectory moveToCenter = drive.trajectoryBuilder(new Pose2d(-57.8, intake_side_y * side_color, Math.toRadians(180)))
                .lineToConstantHeading(new Vector2d(-57.8, intake_distal_y * side_color))
                .build();

        Trajectory back = drive.trajectoryBuilder(new Pose2d(-57.8, intake_distal_y * side_color, Math.toRadians(180)))
                .lineToConstantHeading(new Vector2d(-50, intake_distal_y * side_color))
                .build();
        Trajectory moveToIntake = drive.trajectoryBuilder(new Pose2d(-48, intake_distal_y * side_color, Math.toRadians(180)))
                .lineToConstantHeading(new Vector2d(intake_nearGrab_x, intake_distal_y * side_color))
                .build();

//        drive.followTrajectorySequence(toMediByLine);
//        drive.followTrajectory(moveToCenter);
//        drive.followTrajectory(back);
        drive.moveTo(new Pose2d(-57.8, intake_side_y * side_color, Math.toRadians(180)), 0);
...
//        drive.setSimpleMoveTolerance(2,5);
    ...
    public void distalMoveToBackDrop() {
        ...
        drive.moveTo(new Pose2d(gateBack_x, intake_gate_y * side_color, Math.toRadians(180)), 0);
        upper.setArmPosition(3900);
        drive.setSimpleMovePower(0.2);
    ...
    public void intakeGate() {
        ...
        Trajectory intake = drive.trajectoryBuilder(new Pose2d(intake_medi_x, intake_medi_y * side_color, Math.toRadians(180.00)))
                .lineToLinearHeading(new Pose2d(grab_x, intake_gate_y * side_color, Math.toRadians(180)))
                .build();

        TrajectorySequence fromIntermediateToProximal = drive.trajectorySequenceBuilder(new Pose2d(grab_x, intake_gate_y * side_color, Math.toRadians(180))) //!metion
    ...
    public void distal_intakeSide_sideBack() {
        if (isStopRequested()) return;
        TrajectorySequence toMediByLine = drive.trajectorySequenceBuilder(spikeMark)
                .lineToLinearHeading(new Pose2d(intake_nearGrab_x, intake_side_y, Math.toRadians(180)))
                .build();
        Trajectory moveToCenter = drive.trajectoryBuilder(new Pose2d(intake_nearGrab_x, intake_side_y, Math.toRadians(180)))
                .lineToConstantHeading(new Vector2d(intake_nearGrab_x, intake_distal_sideNear_y))
                .build();
        Trajectory moveToIntake = drive.trajectoryBuilder(new Pose2d(intake_nearGrab_x, intake_distal_sideNear_y, Math.toRadians(180)))
                .lineToConstantHeading(new Vector2d(intake_nearGrab_x, intake_distal_sideNear_y))
                .build();
        ...
        Trajectory back = drive.trajectoryBuilder(new Pose2d(intake_nearGrab_x + 2, edgePass_y * side_color, Math.toRadians(180)))
                .lineToConstantHeading(new Vector2d(40,  * side_color))
                .build();
    ...
    public void toBackDrop(Route route){
        switch (route){
            case GATE:
