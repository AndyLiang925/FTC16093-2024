...
@TeleOp
public class LAC_Version_DPDrive16093 extends LinearOpMode {//
    ...
    int mode=0;
    private LAC_Version_DPDrive16093.Sequence sequence;
...
//        }
        ...
        while (opModeIsActive()){
            ...
            if(toRun.toTrue()){
                ...
                sequence= LAC_Version_DPDrive16093.Sequence.RUN;
            ...
            if(drop.toTrue()){
                ...
                pd=0;
                pdArm=0;
                sequence= LAC_Version_DPDrive16093.Sequence.RELEASE;
            ...
            if(aim.toTrue()){
                ...
                wrtp=0.34;
                wrt.setPosition(wrtp);
                sequence= LAC_Version_DPDrive16093.Sequence.AIM;
...
//                }
            ...
            if(sequence== LAC_Version_DPDrive16093.Sequence.AIM){
                speed = 0.5;
                if(distal.toTrue()){
                    setArmPosition(200);
                    sleep_with_drive(200);
...
//                    }
            ...
            if(sequence== LAC_Version_DPDrive16093.Sequence.RUN){
                setArmLength(0);
                setArmPosition(0);
                wrtp=1;
                wrt.setPosition(wrtp);
            ...
            if(sequence== LAC_Version_DPDrive16093.Sequence.RELEASE) {
                speed = 0.4;
                if (distal.toTrue()) {
...
//                    }
            ...
            wrt.setPosition(wrtp);
            plane.setPosition(plnp);
            telemetry.addData("操作模式:", sequence== LAC_Version_DPDrive16093.Sequence.AIM?"aim1":(sequence== LAC_Version_DPDrive16093.Sequence.RUN?"run":(sequence== LAC_Version_DPDrive16093.Sequence.RELEASE?"drop":"null")));//drive mode
