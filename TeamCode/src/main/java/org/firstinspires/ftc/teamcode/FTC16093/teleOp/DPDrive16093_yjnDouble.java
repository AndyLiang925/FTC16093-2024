...
@TeleOp
public class DPDrive16093_yjnDouble extends LinearOpMode {//
    ...
    int mode=0;
    private DPDrive16093_yjnDouble.Sequence sequence;
...
//            }
            ...
            if(toRun.toTrue()){
                ...
                wrtp=0.9;
                wrt.setPosition(wrtp);
                sequence= DPDrive16093_yjnDouble.Sequence.RUN;
            ...
            if(drop.toTrue()){
                ...
                pd=0;
                pdArm=0;
                sequence= DPDrive16093_yjnDouble.Sequence.RELEASE;
            ...
            if(aim.toTrue()){
                ...
                wrtp=0.53;
                wrt.setPosition(wrtp);
                sequence= DPDrive16093_yjnDouble.Sequence.AIM;
...
//                }
            ...
            if(sequence== DPDrive16093_yjnDouble.Sequence.AIM){
                speed = 0.5;
                if(distal.toTrue()){
                    setArmPosition(230);
                    leftGrabOpen=true;
...
//                }else{
            ...
            if(sequence== DPDrive16093_yjnDouble.Sequence.RUN){
                setArmLength(0);
                setArmPosition(0);
                wrtp=0.9;
                wrt.setPosition(wrtp);
            ...
            if(sequence== DPDrive16093_yjnDouble.Sequence.RELEASE) {
                speed = 0.4;
                if (armDropUp.toTrue()) {
...
//                    }
            ...
            telemetry.addData("操作模式:", sequence== DPDrive16093_yjnDouble.Sequence.AIM?"aim1":(sequence== DPDrive16093_yjnDouble.Sequence.RUN?"run":(sequence== DPDrive16093_yjnDouble.Sequence.RELEASE?"drop":"null")));//drive mode
